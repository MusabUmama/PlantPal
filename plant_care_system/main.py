...
filename = "/home/pi/plant_care_system/data_storage/capture.jpg"

image.save(filename, "JPEG")

plant_name = plant_classify(image_path=filename)

store_data = send_data_to_cloud(plant_name, moisture, image_path=filename)
